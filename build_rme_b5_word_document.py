...
with open("rme_b5_lessons_enriched.json") as f:
    lessons = json.load(f)
...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA Religious and Moral Education Curriculum B5 (2019)\n")
    style_run(r, 10)
...
output_path = "Basic5_RME_Lesson_Plans_Full_Year.docx"
