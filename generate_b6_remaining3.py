#!/usr/bin/env python3
"""Generate 180 full-year daily lesson plans for Basic 6 remaining subjects:
Creative Arts, History, RME. Uses verified B6 DBs (authentic NaCCA text).
Output: /home/user/{creative_arts,history,rme}_b6_lessons_enriched.json
"""
import json
...
subjects = [
    {"key": "creative_arts", "sid": "creative-arts", "name": "Creative Arts",
     "week_plan": [("Monday", "B6.1", 1), ("Tuesday", "B6.2", 2), ("Wednesday", "B6.1", 1),
                   ("Thursday", "B6.2", 2), ("Friday", "B6.1", 1)]},
    ...
    {"key": "rme", "sid": "rme", "name": "Religious and Moral Education",
     "week_plan": [("Monday", "B6.1", 1), ("Tuesday", "B6.2", 2), ("Wednesday", "B6.3", 3),
                   ("Thursday", "B6.4", 4), ("Friday", "B6.5", 5)]},  # exactly 5 strands
]

RPK = {
    "creative_arts": "Learners sing, dance, draw, mould and role-play from Basic 1-5; they see Ghanaian artworks and performances at festivals, durbars and in the media.",
    "history": "Learners studied ancient Ghana, European contact, colonial rule and the journey to independence in Basic 1-5; they hear historical stories from elders and the media.",
    "rme": "Learners pray and worship with their families (Christian, Islamic, Traditional) and learned about God's creation, worship, religious leaders and family life in Basic 1-5.",
}
