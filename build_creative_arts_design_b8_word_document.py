...
with open("creative_arts_design_b8_lessons_enriched.json") as f:
    lessons = json.load(f)
...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA Creative Arts and Design CCP Curriculum B8 (2021)\n")
    style_run(r, 10)
...
output_path = "Basic8_Creative_Arts_Design_Lesson_Plans_Full_Year.docx"
