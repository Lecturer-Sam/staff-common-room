#!/usr/bin/env python3
"""Generate 180 full-year daily lesson plans for Basic 5 remaining subjects:
Creative Arts, History, RME. Uses verified B5 DBs (authentic NaCCA text).
Output: /home/user/{creative_arts,history,rme}_b5_lessons_enriched.json
"""
import json
...
subjects = [
    {"key": "creative_arts", "sid": "creative-arts", "name": "Creative Arts",
     "week_plan": [("Monday", "B5.1", 1), ("Tuesday", "B5.2", 2), ("Wednesday", "B5.1", 1),
                   ("Thursday", "B5.2", 2), ("Friday", "B5.1", 1)]},
    {"key": "history", "sid": "history", "name": "History",
     "week_plan": None},  # global indicator cycle: 10 indicators x 18 sessions
    {"key": "rme", "sid": "rme", "name": "Religious and Moral Education",
     "week_plan": [("Monday", "B5.1", 1), ("Tuesday", "B5.2", 2), ("Wednesday", "B5.3", 3),
                   ("Thursday", "B5.4", 4), ("Friday", "B5.5", 5)]},  # exactly 5 strands
]

RPK = {
    "creative_arts": "Learners sing, dance, draw, mould and role-play from Basic 1-4; they see Ghanaian artworks and performances at festivals, durbars and in the media.",
    "history": "Learners studied the people of Ghana, historical locations, colonial rule and early nationalism in Basic 1-4; they hear historical stories from elders and the media.",
    "rme": "Learners pray and worship with their families (Christian, Islamic, Traditional) and learned about God's creation, worship, festivals, religious leaders and the family in Basic 1-4.",
}
