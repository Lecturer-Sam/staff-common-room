...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA Mathematics Curriculum B4 (2019)\n")
    style_run(r, 10)
...
output_path = "Basic4_Mathematics_Lesson_Plans_Full_Year.docx"
