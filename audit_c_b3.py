#!/usr/bin/env python3
"""Audit C (B3) - Verify the 4 B3 enriched lesson JSONs and DOCX lesson-plan files."""
import json, re
...
CODE_RE = re.compile(r'^B3\.\d+\.\d+\.\d+\.\d+$')
...
SUBJECTS = {
    'math_b3':      ('curriculum_db/mathematics_B3_curriculum_db_clean.json',     'Basic3_Mathematics_Lesson_Plans_Full_Year.docx'),
    'science_b3':   ('curriculum_db/science_B3_curriculum_db_clean.json',         'Basic3_Science_Lesson_Plans_Full_Year.docx'),
    'english_b3':   ('curriculum_db/english-language_B3_curriculum_db_clean.json','Basic3_English_Lesson_Plans_Full_Year.docx'),
    'ghanaian_b3':  ('curriculum_db/ghanaian-language_B3_curriculum_db_clean.json','Basic3_Ghanaian_Language_Lesson_Plans_Full_Year.docx'),
}
...
def audit_docx(stem, docx_name, lessons):
    ...
    if 'Basic 3' not in j: issues.append('title does not say Basic 3')
