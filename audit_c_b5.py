#!/usr/bin/env python3
"""Audit C (B5) - Verify the 4 B3 enriched lesson JSONs and DOCX lesson-plan files."""
import json, re
...
CODE_RE = re.compile(r'^B5.\d+\.\d+\.\d+\.\d+$')
...
SUBJECTS = {
    'math_b5':      ('curriculum_db/mathematics_B5_curriculum_db_clean.json',     'Basic5_Mathematics_Lesson_Plans_Full_Year.docx'),
    'science_b5':   ('curriculum_db/science_B5_curriculum_db_clean.json',         'Basic5_Science_Lesson_Plans_Full_Year.docx'),
    'english_b5':   ('curriculum_db/english-language_B5_curriculum_db_clean.json','Basic5_English_Lesson_Plans_Full_Year.docx'),
    'ghanaian_b5':  ('curriculum_db/ghanaian-language_B5_curriculum_db_clean.json','Basic5_Ghanaian_Language_Lesson_Plans_Full_Year.docx'),
}
...
def audit_docx(stem, docx_name, lessons):
    ...
    if 'Basic 5' not in j: issues.append('title does not say Basic 5')
