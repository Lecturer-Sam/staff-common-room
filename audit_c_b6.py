#!/usr/bin/env python3
"""Audit C (B6) - Verify the 4 B3 enriched lesson JSONs and DOCX lesson-plan files."""
import json, re
...
CODE_RE = re.compile(r'^B6.\d+\.\d+\.\d+\.\d+$')
...
SUBJECTS = {
    'math_b6':      ('curriculum_db/mathematics_B6_curriculum_db_clean.json',     'Basic6_Mathematics_Lesson_Plans_Full_Year.docx'),
    'science_b6':   ('curriculum_db/science_B6_curriculum_db_clean.json',         'Basic6_Science_Lesson_Plans_Full_Year.docx'),
    'english_b6':   ('curriculum_db/english-language_B6_curriculum_db_clean.json','Basic6_English_Lesson_Plans_Full_Year.docx'),
    'ghanaian_b6':  ('curriculum_db/ghanaian-language_B6_curriculum_db_clean.json','Basic6_Ghanaian_Language_Lesson_Plans_Full_Year.docx'),
}
...
def audit_docx(stem, docx_name, lessons):
    ...
    if 'Basic 6' not in j: issues.append('title does not say Basic 6')
