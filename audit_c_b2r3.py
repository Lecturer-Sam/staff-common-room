#!/usr/bin/env python3
"""Audit C (B2 remaining-3) - Verify Creative Arts, History, RME B2 lesson JSONs + DOCX."""
import json, re
...
SUBJECTS = {
    'creative_arts_b2': ('curriculum_db/creative-arts_B2_curriculum_db_clean.json', 'Basic2_Creative_Arts_Lesson_Plans_Full_Year.docx'),
    'history_b2':       ('curriculum_db/history_B2_curriculum_db_clean.json',      'Basic2_History_Lesson_Plans_Full_Year.docx'),
    'rme_b2':           ('curriculum_db/rme_B2_curriculum_db_clean.json',          'Basic2_RME_Lesson_Plans_Full_Year.docx'),
}
