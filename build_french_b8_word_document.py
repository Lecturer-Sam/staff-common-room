...
with open("french_b8_lessons_enriched.json") as f:
    lessons = json.load(f)
...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA French CCP Curriculum B8 (2021)\n")
    style_run(r, 10)
...
output_path = "Basic8_French_Lesson_Plans_Full_Year.docx"
