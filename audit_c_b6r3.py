#!/usr/bin/env python3
"""Audit C (B6 remaining-3) - Verify Creative Arts, History, RME B6 lesson JSONs + DOCX."""
import json, re
...
SUBJECTS = {
    'creative_arts_b6': ('curriculum_db/creative-arts_B6_curriculum_db_clean.json', 'Basic6_Creative_Arts_Lesson_Plans_Full_Year.docx'),
    'history_b6':       ('curriculum_db/history_B6_curriculum_db_clean.json',      'Basic6_History_Lesson_Plans_Full_Year.docx'),
    'rme_b6':           ('curriculum_db/rme_B6_curriculum_db_clean.json',          'Basic6_RME_Lesson_Plans_Full_Year.docx'),
}
