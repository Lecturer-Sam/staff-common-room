...
with open("creative_arts_b6_lessons_enriched.json") as f:
    lessons = json.load(f)
...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA Creative Arts Curriculum B6 (2019)\n")
    style_run(r, 10)
...
output_path = "Basic6_Creative_Arts_Lesson_Plans_Full_Year.docx"
