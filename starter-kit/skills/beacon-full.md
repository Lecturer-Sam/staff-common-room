...
FULL on-demand reference for strict Beacon mode. The always-loaded slim skill is
skills/beacon.md — the agent reads sections of THIS file only when a task needs them.
To refresh: copy that file over everything below this comment.
-->
