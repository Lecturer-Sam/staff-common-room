...
with open("owop_lessons_enriched.json") as f:
    lessons = json.load(f)
...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run("Our World Our People\n")
    style_run(r, 10)
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA Our World Our People Curriculum B1 (2019)\n")
    style_run(r, 10)
...
output_path = "Basic1_OWOP_Lesson_Plans_Full_Year.docx"
