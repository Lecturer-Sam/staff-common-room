#!/usr/bin/env python3
"""Audit C (B9) - Verify the 4 B3 enriched lesson JSONs and DOCX lesson-plan files."""
import json, re
...
SUBJECTS = {
    'math_b9':      ('curriculum_db/mathematics_B9_curriculum_db_clean.json',     'Basic9_Mathematics_Lesson_Plans_Full_Year.docx'),
    'science_b9':   ('curriculum_db/science_B9_curriculum_db_clean.json',         'Basic9_Science_Lesson_Plans_Full_Year.docx'),
    'english_b9':   ('curriculum_db/english-language_B9_curriculum_db_clean.json','Basic9_English_Lesson_Plans_Full_Year.docx'),
    'ghanaian_b9':  ('curriculum_db/ghanaian-language_B9_curriculum_db_clean.json','Basic9_Ghanaian_Language_Lesson_Plans_Full_Year.docx'),
}
...
def audit_docx(stem, docx_name, lessons):
    ...
    if 'Basic 9' not in j: issues.append('title does not say Basic 9')
