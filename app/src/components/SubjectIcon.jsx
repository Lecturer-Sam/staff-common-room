/**
 * SubjectIcon — renders the correct SVG icon for a given subject,
 * wrapped in a colored badge using the subject theme.
 *
 * Props:
 *   subjectId  — e.g. "mathematics", "science"
 *   theme      — result of getSubjectTheme(subjectId)
 *   size       — "md" (default, 40×40) | "lg" (48×48)
 */
...
const PATHS = {
  ...
  'physical-education': (
    <>
      ...
      <path d="M6.5 10h11l-1.5 9H8L6.5 10z" />
    </>
  ),
  default: (
    <>
