#!/usr/bin/env python3
"""Audit C (B2) - Verify the 4 B2 enriched lesson JSONs and DOCX lesson-plan files."""
import json, re
...
CODE_RE = re.compile(r'^B2\.\d+\.\d+\.\d+\.\d+$')
...
SUBJECTS = {
    'math_b2':      ('curriculum_db/mathematics_B2_curriculum_db_clean.json',     'Basic2_Mathematics_Lesson_Plans_Full_Year.docx'),
    'science_b2':   ('curriculum_db/science_B2_curriculum_db_clean.json',         'Basic2_Science_Lesson_Plans_Full_Year.docx'),
    'english_b2':   ('curriculum_db/english-language_B2_curriculum_db_clean.json','Basic2_English_Lesson_Plans_Full_Year.docx'),
    'ghanaian_b2':  ('curriculum_db/ghanaian-language_B2_curriculum_db_clean.json','Basic2_Ghanaian_Language_Lesson_Plans_Full_Year.docx'),
}
...
def audit_docx(stem, docx_name, lessons):
    ...
    if 'Basic 2' not in j: issues.append('title does not say Basic 2')
