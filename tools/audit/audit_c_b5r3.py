#!/usr/bin/env python3
"""Audit C (B5 remaining-3) - Verify Creative Arts, History, RME B5 lesson JSONs + DOCX."""
import json, re
...
SUBJECTS = {
    'creative_arts_b5': ('curriculum_db/creative-arts_B5_curriculum_db_clean.json', 'Basic5_Creative_Arts_Lesson_Plans_Full_Year.docx'),
    'history_b5':       ('curriculum_db/history_B5_curriculum_db_clean.json',      'Basic5_History_Lesson_Plans_Full_Year.docx'),
    'rme_b5':           ('curriculum_db/rme_B5_curriculum_db_clean.json',          'Basic5_RME_Lesson_Plans_Full_Year.docx'),
}
