#!/usr/bin/env python3
"""Audit C (B9 remaining-6) - Verify RME, Computing, Social Studies, Career Tech, CAD, French B9 lesson JSONs + DOCX lesson-plan files."""
import json, re
...
CODE_RE = re.compile(r'^B9\.\d+\.\d+\.\d+\.\d+$')
...
SUBJECTS = {
    'rme_b9':                  ('curriculum_db/rme_B9_curriculum_db_clean.json',                  'Basic9_RME_Lesson_Plans_Full_Year.docx'),
    'computing_b9':            ('curriculum_db/computing_B9_curriculum_db_clean.json',            'Basic9_Computing_Lesson_Plans_Full_Year.docx'),
    'social_studies_b9':       ('curriculum_db/social-studies_B9_curriculum_db_clean.json',       'Basic9_Social_Studies_Lesson_Plans_Full_Year.docx'),
    'career_technology_b9':    ('curriculum_db/career-technology_B9_curriculum_db_clean.json',    'Basic9_Career_Technology_Lesson_Plans_Full_Year.docx'),
    'creative_arts_design_b9': ('curriculum_db/creative-arts-design_B9_curriculum_db_clean.json', 'Basic9_Creative_Arts_Design_Lesson_Plans_Full_Year.docx'),
    'french_b9':               ('curriculum_db/french_B9_curriculum_db_clean.json',               'Basic9_French_Lesson_Plans_Full_Year.docx'),
}
...
def audit_docx(stem, docx_name, lessons):
    ...
    if 'B9' not in j: issues.append('title does not say B9')
