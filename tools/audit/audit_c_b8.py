#!/usr/bin/env python3
"""Audit C (B8) - Verify the 4 B3 enriched lesson JSONs and DOCX lesson-plan files."""
import json, re
...
SUBJECTS = {
    'math_b8':      ('curriculum_db/mathematics_B8_curriculum_db_clean.json',     'Basic8_Mathematics_Lesson_Plans_Full_Year.docx'),
    'science_b8':   ('curriculum_db/science_B8_curriculum_db_clean.json',         'Basic8_Science_Lesson_Plans_Full_Year.docx'),
    'english_b8':   ('curriculum_db/english-language_B8_curriculum_db_clean.json','Basic8_English_Lesson_Plans_Full_Year.docx'),
    'ghanaian_b8':  ('curriculum_db/ghanaian-language_B8_curriculum_db_clean.json','Basic8_Ghanaian_Language_Lesson_Plans_Full_Year.docx'),
}
...
def audit_docx(stem, docx_name, lessons):
    ...
    if 'Basic 8' not in j: issues.append('title does not say Basic 8')
