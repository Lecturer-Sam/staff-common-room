#!/usr/bin/env python3
"""Audit C (B3 remaining-3) - Verify Creative Arts, History, RME B2 lesson JSONs + DOCX."""
import json, re
...
SUBJECTS = {
    'creative_arts_b3': ('curriculum_db/creative-arts_B3_curriculum_db_clean.json', 'Basic3_Creative_Arts_Lesson_Plans_Full_Year.docx'),
    'history_b3':       ('curriculum_db/history_B3_curriculum_db_clean.json',      'Basic3_History_Lesson_Plans_Full_Year.docx'),
    'rme_b3':           ('curriculum_db/rme_B3_curriculum_db_clean.json',          'Basic3_RME_Lesson_Plans_Full_Year.docx'),
}
