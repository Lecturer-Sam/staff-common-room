#!/usr/bin/env python3
"""Audit C (B7 remaining-6) - Verify RME, Computing, Social Studies, Career Tech,
CAD, French B7 lesson JSONs + DOCX lesson-plan files."""
import json, re
...
SUBJECTS = {
    'rme_b7':                  ('curriculum_db/rme_B7_curriculum_db_clean.json',                  'Basic7_RME_Lesson_Plans_Full_Year.docx'),
    'computing_b7':            ('curriculum_db/computing_B7_curriculum_db_clean.json',            'Basic7_Computing_Lesson_Plans_Full_Year.docx'),
    'social_studies_b7':       ('curriculum_db/social-studies_B7_curriculum_db_clean.json',       'Basic7_Social_Studies_Lesson_Plans_Full_Year.docx'),
    'career_technology_b7':    ('curriculum_db/career-technology_B7_curriculum_db_clean.json',    'Basic7_Career_Technology_Lesson_Plans_Full_Year.docx'),
    'creative_arts_design_b7': ('curriculum_db/creative-arts-design_B7_curriculum_db_clean.json', 'Basic7_Creative_Arts_Design_Lesson_Plans_Full_Year.docx'),
    'french_b7':               ('curriculum_db/french_B7_curriculum_db_clean.json',               'Basic7_French_Lesson_Plans_Full_Year.docx'),
}
...
def audit_docx(stem, docx_name, lessons):
    ...
    if 'Basic 7' not in j: issues.append('title does not say Basic 7')
