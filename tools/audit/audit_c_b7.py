#!/usr/bin/env python3
"""Audit C (B7) - Verify the 4 B3 enriched lesson JSONs and DOCX lesson-plan files."""
import json, re
...
SUBJECTS = {
    'math_b7':      ('curriculum_db/mathematics_B7_curriculum_db_clean.json',     'Basic7_Mathematics_Lesson_Plans_Full_Year.docx'),
    'science_b7':   ('curriculum_db/science_B7_curriculum_db_clean.json',         'Basic7_Science_Lesson_Plans_Full_Year.docx'),
    'english_b7':   ('curriculum_db/english-language_B7_curriculum_db_clean.json','Basic7_English_Lesson_Plans_Full_Year.docx'),
    'ghanaian_b7':  ('curriculum_db/ghanaian-language_B7_curriculum_db_clean.json','Basic7_Ghanaian_Language_Lesson_Plans_Full_Year.docx'),
}
