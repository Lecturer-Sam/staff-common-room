...
with open("ghanaian_b4_lessons_enriched.json") as f:
    lessons = json.load(f)
...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA Ghanaian Language Curriculum B4 (2019)\n")
    style_run(r, 10)
...
output_path = "Basic4_Ghanaian_Language_Lesson_Plans_Full_Year.docx"
