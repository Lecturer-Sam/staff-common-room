...
with open("english_b3_lessons_enriched.json") as f:
    lessons = json.load(f)
...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA English Language Curriculum B3 (2019)\n")
    style_run(r, 10)
...
output_path = "Basic3_English_Lesson_Plans_Full_Year.docx"
