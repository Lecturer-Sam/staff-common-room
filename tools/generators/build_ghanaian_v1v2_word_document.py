...
with open("ghanaian_language_lessons_enriched.json") as f:
    lessons = json.load(f)
...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA Ghanaian Language Curriculum B1 (2019)\n")
    style_run(r, 10)
...
output_path = "Basic1_Ghanaian_Language_Lesson_Plans_Full_Year_v2.docx"
