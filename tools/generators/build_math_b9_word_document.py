...
with open("math_b9_lessons_enriched.json") as f:
    lessons = json.load(f)
...
for idx, l in enumerate(lessons):
    ...
    style_run(r, 10, bold=True)
    r = id_p.add_run(f"NaCCA Mathematics CCP Curriculum B9 (2020)\n")
    style_run(r, 10)
...
output_path = "Basic9_Mathematics_Lesson_Plans_Full_Year.docx"
