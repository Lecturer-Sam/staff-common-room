...
BODIES = {
    'creative_arts_B4-B6.pdf': (228570, None),
    'history.pdf': (101694, None),
    'rme_B1-B6.pdf': (106280, None),
}

JOBS = [
    ('creative-arts', 'B6', 'creative_arts_B4-B6.pdf',
     {1: '1. VISUAL ARTS', 2: '2. PERFORMING ARTS'}),
    ('history', 'B6', 'history.pdf',
     {3: '3. EUROPEANS IN GHANA', 4: '4. COLONISATION AND DEVELOPMENTS UNDER COLONIAL RULE IN GHANA',
      5: '5. JOURNEY TO INDEPENDENCE', 6: '6. INDEPENDENT GHANA'}),
    ('rme', 'B6', 'rme_B1-B6.pdf',
