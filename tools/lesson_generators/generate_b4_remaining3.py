...
subjects = [
    {"key": "creative_arts", "sid": "creative-arts", "name": "Creative Arts",
     "week_plan": [("Monday", "B4.1", 1), ("Tuesday", "B4.2", 2), ("Wednesday", "B4.1", 1),
                   ("Thursday", "B4.2", 2), ("Friday", "B4.1", 1)]},
    ...
    {"key": "rme", "sid": "rme", "name": "Religious and Moral Education",
     "week_plan": [("Monday", "B4.1", 1), ("Tuesday", "B4.2", 2), ("Wednesday", "B4.3", 3),
                   ("Thursday", "B4.4", 4), ("Friday", "B4.5", 5)]},  # exactly 5 strands
]

RPK = {
    "creative_arts": "Learners sing, dance, draw, mould and role-play from Basic 1-3; they see Ghanaian artworks and performances at festivals, durbars and in the media.",
    "history": "Learners studied the people, historical locations and early European contact in Basic 1-3; they hear historical stories from elders and the media.",
    "rme": "Learners pray and worship with their families (Christian, Islamic, Traditional) and learned about God's creation, worship, festivals and religious leaders in Basic 1-3.",
}
